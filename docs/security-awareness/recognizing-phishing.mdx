...
description: Learn how to spot phishing emails, texts, and calls before you become a victim. Includes red flags, examples, and what to do if you're targeted.
keywords: [phishing, email scams, smishing, vishing, phishing prevention, scam emails, how to spot phishing, cybersecurity]
image: /img/social-cards/phishing-social-card.png
---
